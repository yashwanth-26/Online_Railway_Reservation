...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable()
			...
			.antMatchers("/train/all/**").access("hasRole('ROLE_USER') or hasRole('ROLE_ADMIN')")
			.antMatchers("/train/admin/**").access("hasRole('ROLE_ADMIN')")
			.antMatchers("/payment/all/**").access("hasRole('ROLE_USER') or hasRole('ROLE_ADMIN')")
